...
public class CalculatorServiceServiceLocator extends org.apache.axis.client.Service implements com.webservice.soap.axis1.CalculatorServiceService {
    ...
    private java.lang.String CalculatorService_address = "http://localhost:8080/WEB-SERVICE-SOAP-JAX-RPC-AXIS-1/services/CalculatorService";
    ...
    public com.webservice.soap.axis1.CalculatorService getCalculatorService() throws javax.xml.rpc.ServiceException {
    ...
    public com.webservice.soap.axis1.CalculatorService getCalculatorService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.webservice.soap.axis1.CalculatorServiceSoapBindingStub _stub = new com.webservice.soap.axis1.CalculatorServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.webservice.soap.axis1.CalculatorService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.webservice.soap.axis1.CalculatorServiceSoapBindingStub _stub = new com.webservice.soap.axis1.CalculatorServiceSoapBindingStub(new java.net.URL(CalculatorService_address), this);
                _stub.setPortName(getCalculatorServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://axis1.soap.webservice.com", "CalculatorServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://axis1.soap.webservice.com", "CalculatorService"));
        }
